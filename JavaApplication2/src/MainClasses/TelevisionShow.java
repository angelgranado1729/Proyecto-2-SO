...
public class TelevisionShow {
    ...
    public TelevisionShow(String tvShow, String packageImg, LinkedList yellowCards, LinkedList greenCards, LinkedList redCards) {
    ...
    private void createAndEnqueueCharacter(Node characterNode) {
        ...
        CharacterTv character = characterNode.getTInfo();
